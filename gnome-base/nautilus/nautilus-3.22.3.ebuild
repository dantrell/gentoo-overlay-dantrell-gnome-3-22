...
IUSE="exif gnome +introspection +previewer selinux sendto tracker vanilla-icon vanilla-icon-grid vanilla-menu vanilla-menu-compress vanilla-rename vanilla-search vanilla-thumbnailer xmp"
